      ...
      >
        ...
        >
          ...
          <div className="relative z-10">
            <div className="w-12 h-12 rounded-xl bg-blue-500/10 flex items-center justify-center mb-6 mx-auto group-hover:bg-blue-500/20 transition-colors">
            ...
            <p className="text-xl md:text-2xl font-medium tracking-tight text-white group-hover:text-blue-400 transition-colors">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="w-12 h-12 rounded-xl bg-purple-500/10 flex items-center justify-center mb-6 mx-auto group-hover:bg-purple-500/20 transition-colors">
            ...
            <p className="text-xl md:text-2xl font-medium tracking-tight text-white group-hover:text-purple-400 transition-colors">
              @zaimnnabil
            </p>
          </div>
