...
const Contact = () => {
  ...
  return (
    <section ref={ref} id="contact" className="py-24 md:py-40 px-6 max-w-7xl mx-auto text-center">
      {/* Section Header */}
      <div 
      ...
      >
        ...
        <a 
          ...
          aria-label="Send email to zaimunnabil1@gmail.com" 
          className="group relative p-8 md:p-10 glass-premium rounded-2xl glow-card overflow-hidden transition-all duration-500 focus-visible:ring-2 focus-visible:ring-red-500/50 outline-none"
        >
          {/* Glow Effect */}
        ...
        <a 
          ...
          className="group relative p-8 md:p-10 glass-premium rounded-2xl glow-card overflow-hidden transition-all duration-500 focus-visible:ring-2 focus-visible:ring-teal-500/50 outline-none"
        >
          {/* Glow Effect */}
          ...
          {/* Arrow */}
          <div className="absolute top-6 right-6 w-8 h-8 rounded-full bg-white/5 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all transform translate-x-2 group-hover:translate-x-0">
            <svg className="w-3 h-3 text-teal-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
            </svg>
          </div>
        </a>
